...
public class TilePieceDefinition : MonoBehaviour
{
    ...
    public Vector2 childCellSize = new Vector2(TilePlacementGrid.DefaultCellWidth, TilePlacementGrid.DefaultCellHeight);
    ...
    void OnValidate()
    {
        childCellSize = new Vector2(
            TilePlacementGrid.SnapPositiveToTileMultiple(childCellSize.x, TilePlacementGrid.DefaultCellWidth),
            TilePlacementGrid.SnapPositiveToTileMultiple(childCellSize.y, TilePlacementGrid.DefaultCellHeight)
        );
